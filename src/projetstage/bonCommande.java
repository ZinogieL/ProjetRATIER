 ...
 * @author solto
 */
public class bonCommande extends javax.swing.JFrame {

    /**
     * Creates new form bonCommande
     */
    public bonCommande() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            boolean complete = zonetext.print();
            if (complete) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(bonCommande.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
