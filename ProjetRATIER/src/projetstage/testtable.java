...
public class testtable extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (tblModel.getRowCount() == 0) {
            JOptionPane.showMessageDialog(this, "Vérifier que le tableau n'est pas vide");
        } else {
            String num1, num2, num3, num4;
            try {
                Class.forName("com.mysql.cj.jdbc.Driver");
                cont = DriverManager.getConnection("jdbc:mysql://localhost/stage", "root", "");

                for (int row = 0; row < tblModel.getRowCount(); row++) {
                    
                    num1 = tblModel.getValueAt(row, 0).toString();
                    num2 = tblModel.getValueAt(row, 1).toString();
                    num3 = tblModel.getValueAt(row, 2).toString();
                    num4 = tblModel.getValueAt(row, 3).toString();
                    
                    pstt = cont.prepareStatement("insert into commandes(REF_VINS,BOUTEILLE,CARTON,PRIX_UNIT)values(?,?,?,?)");
                
                pstt.setString(3, num1);
                pstt.setString(4, num2);
                pstt.setString(5, num3);
                pstt.setString(6, num4);
                pstt.executeUpdate();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(testtable.class
